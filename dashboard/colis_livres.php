  ...
  <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      <?php foreach ($commandes_livrees as $commandes_livree) : ?>
        <tr>
          <td><?= $commandes_livree['communes'] ?></td>
          <td><?= $commandes_livree['cout_global'] ?></td>
          <td><?= $commandes_livree['cout_livraison'] ?></td>
          <td><?= $commandes_livree['cout_reel'] ?></td>
          <td><?= $commandes_livree['nom_boutique'] ?></td>
          <td><?= $commandes_livree['fullname'] ?></td>

          <td>
            <?php if ($commandes_livree['statut'] !== null) : ?>
              <?php if ($commandes_livree['statut'] == 'Non Livré') : ?>
                <span class="badge badge-danger badge-lg"><?= $commandes_livree['statut'] ?></span>
              <?php else : ?>
                <span class="badge badge-success badge-lg"><?= $commandes_livree['statut'] ?></span>
              <?php endif; ?>
            <?php else : ?>
