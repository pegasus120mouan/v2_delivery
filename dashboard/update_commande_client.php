...
<body>
    ...
    //require_once '../inc/functions/requete/clients/req_commandes_clients.php'; 

    require_once '../inc/functions/requete/clients/requete_commandes_clients.php'; 

    
   // requete_commandes_clients.php
...
<div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="exampleInputName1"
                                                    placeholder="Communes" name="id" value="<?php echo $modif_commandes['id']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputName1">Communes</label>
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    placeholder="Communes" name="communes" value="<?php echo $modif_commandes['communes']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail3">Côut Global</label>
                                                <input type="text" class="form-control" id="exampleInputEmail3"
                                                    placeholder="Côut Global" name="cout_global" value="<?php echo $modif_commandes['cout_global']; ?>">
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <input type="date" class="form-control" id="exampleInputName1"
                                                    placeholder="date" name="date" value="<?php echo $modif_commandes['date_commande']; ?>">
                                            </div>
                                            </div>
