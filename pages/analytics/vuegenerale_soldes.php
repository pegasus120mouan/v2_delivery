...
$stmt_soldes = $conn->prepare("SELECT
date_commande,
SUM(recette) AS total_recettes,
SUM(depense) AS total_depenses,
(SUM(recette) - SUM(depense)) AS gain_jour
FROM
points_livreurs
GROUP BY
date_commande 
...
<head>
  ...
  <title>Points des caisses</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <th>Gain du jour</th>
                  ...
                  <tr>
                  <td><?=$point['date_commande']?></td>
                  <td><?=$point['total_recettes']?></td>
                  <td><?=$point['total_depenses']?></td>
                  <td><?=$point['gain_jour']?></td>
                  </tr>
                  </tbody>
                  <?php endforeach; ?>
                </table>
