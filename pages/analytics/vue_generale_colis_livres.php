...
$stmt = $conn->prepare(
  ...
  JOIN utilisateurs AS client ON commandes.utilisateur_id = client.id
  JOIN boutiques ON client.boutique_id = boutiques.id
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Liste des colis livrés</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
