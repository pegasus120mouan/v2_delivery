...
<div class="row">
          ...
          <div class="modal-content">
            <div class="modal-body">
              <form action="traitement_commande_livreurs_update.php" method="post">
                ...
                <input type="hidden" name="redirect_page" value="page_recherche.php">
  ...
  <div class="pagination-container bg-secondary d-flex justify-content-center w-100 text-white p-3">
    <?php if ($page > 1): ?>
        <a href="?recherche=<?= urlencode($recherche) ?>&page=1&limit=<?= $limit ?>" class="btn btn-primary">&lt;&lt;</a>
    ...
    <?php if ($page < $total_pages): ?>
        <a href="?recherche=<?= urlencode($recherche) ?>&page=<?= $page + 1 ?>&limit=<?= $limit ?>" class="btn btn-primary">&gt;</a>
        <a href="?recherche=<?= urlencode($recherche) ?>&page=<?= $total_pages ?>&limit=<?= $limit ?>" class="btn btn-primary">&gt;&gt;</a>
    <?php endif; ?>
  </div>
